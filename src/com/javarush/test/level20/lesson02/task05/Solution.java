...
public class Solution {
    public static void main(java.lang.String[] args) {
        ...
        try {
            ...
            OutputStream outputStream = new FileOutputStream("/Users/inna/Documents/2.txt");
            InputStream inputStream = new FileInputStream("/Users/inna/Documents/2.txt");
    ...
    public static class Object {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            if (string1!=null) printWriter.println(string1.number);
                else printWriter.println("null");
            if (string2!=null) printWriter.println(string2.number);
                else printWriter.println("null");
            printWriter.close();
        }
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            if (!(str = bufferedReader.readLine()).equals("null")) {
